package cavazos.gerardo.myfeelings.utilities

import android.content.Context
import android.graphics.*
import android.graphics.drawable.Drawable
import androidx.core.content.ContextCompat
import cavazos.gerardo.myfeelings.R
...
class CustomCircleDrawable: Drawable {
    ...
    constructor(context: Context, emociones: ArrayList<Emociones>){
        ...
        grosorMetrica = context.resources.getDimensionPixelSize(R.dimen.graphWidh)
